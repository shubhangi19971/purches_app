    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_category', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='category_products', to='stocks_app.productcategory')),
                ('product_gst', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='gst_products', to='stocks_app.gst')),
                ('product_offer', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='offer_products', to='stocks_app.offer')),
            ],
        ),
    ]
