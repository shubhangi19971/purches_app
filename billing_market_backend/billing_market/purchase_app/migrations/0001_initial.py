    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_in_order', to='purchase_app.order')),
                ('product_order', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='order_list', to='stocks_app.product')),
            ],
        ),
        migrations.AddField(
            model_name='order',
